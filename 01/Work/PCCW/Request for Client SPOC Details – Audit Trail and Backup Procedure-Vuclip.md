...
- How are users provisioned and approved?
- How are user roles and permissions maintained?
- Which role/permission has access for account maintenance, program changes, data changes and configuration changes?
- Is periodic user access review performed?
...
- How are system incidents and job failures monitored?
- Does management rely on the Oracle NetSuite SOC report?

---

**2. End-to-End Process Flow**

- Could you walk us through the end-to-end process flow from contract initiation / order creation through to billing, cash collection, journal posting and financial reporting?
- What are the key systems involved throughout the process?
...
- What upstream systems interface with NetSuite?
- What downstream systems receive information from NetSuite?
- Which interfaces are automated and which are manual?
- How are interface exceptions identified and resolved?
